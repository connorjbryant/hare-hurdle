...
namespace UltimateReplay
{
    ...
    {
        // Private
        private const float playPauseWidth = 240;
        private const float playPauseHeight = 200;
        private const float stateButtonWidth = 480;
        private const float stateButtonHeight = 180;
        private const float lookMultiplier = 1500;
